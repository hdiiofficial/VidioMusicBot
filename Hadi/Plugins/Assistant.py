...
from Hadi import ASSISTANT_PREFIX, SUDOERS, app, random_assistant
from Hadi.Database import get_assistant, save_assistant
...
async def assis_change(_, message: Message):
    ...
    if not _assistant:
        await message.reply_text(
            f"**__Hadi Music Bot Assistant Alloted__**\n\nAssistant No. **{ran_ass}**"
        )
        assis = {
