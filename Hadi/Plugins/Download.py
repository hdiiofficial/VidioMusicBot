...
from Hadi import MUSIC_BOT_NAME, app
from Hadi.Utilities.changers import time_to_seconds
from Hadi.Utilities.download import get_formats, get_type
...
inl = InlineKeyboardMarkup(
    [[InlineKeyboardButton(text="Mengdownload......", callback_data=f"down")]]
)

upl = InlineKeyboardMarkup(
    [[InlineKeyboardButton(text="MengUpload........", callback_data=f"down")]]
)
    ...
    buttons = [
        [
            InlineKeyboardButton(
                text="Download/Upload Gagal......", callback_data=f"down"
            )
        ],
        [
            InlineKeyboardButton(
...
⚡️ __Youtube Inline Download Powered By @Jowo_Store .__"""
